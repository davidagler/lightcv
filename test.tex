...
\documentclass[p1noheader, 12pt, lightmode]{lightcv}
\hypersetup{linkcolor=magenta!90, urlcolor=magenta!90}
...
\ContactInfo[2][
    ...
    \crow[\faEnvelopeO]{\url{john.doe@example.com}}
][
    \crow[\faLinkedin]{linkedin.com/in/johndoe}
    \crow[\faGithub]{\href{www.github.com/davidagler}{@davidagler}}
